const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-CmUBhctP.js","assets/camperStore-Dimdq0ff.js","assets/Home-C6yJiHKG.css","assets/CamperDetails-CSqhYBId.js","assets/reservationStore-DFFtcQAo.js","assets/CamperDetails-BONwOFMc.css","assets/Login-CSw0Gd1u.js","assets/Login-SUqwteKX.css","assets/Admin-BcM6ONj5.js","assets/Admin-CI0lGVDo.css","assets/Reservations-C9t2UV1D.js","assets/Reservations-HNhLT4Se.css","assets/NotFound-CibQ-9Ag.js","assets/NotFound-KrQrWJqe.css","assets/PrivacyPolicy-C_9U42Xe.js","assets/PrivacyPolicy-CiPdi88c.css","assets/CookiePolicy-Cnnvv7kZ.js","assets/CookiePolicy-ZUyPVcOV.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nP=300,rP=Kg("authIdTokenMaxAge")||nP;let ep=null;const sP=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>rP)return;const s=n?.token;ep!==s&&(ep=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function iP(t=Jl()){const e=Ia(t,"auth");if(e.isInitialized())return e.getImmediate();const n=OS(t,{popupRedirectResolver:XC,persistence:[lC,JS,F_]}),r=Kg("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=sP(i.toString());GS(n,a,()=>a(n.currentUser)),WS(n,c=>a(c))}}const s=Hg("auth");return s&&VS(n,`http://${s}`),n}function oP(){return document.getElementsByTagName("head")?.[0]??document}AS({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=sn("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",oP().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});tP("Browser");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z_="firebasestorage.googleapis.com",aP="storageBucket",cP=120*1e3,lP=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var ln;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(ln||(ln={}));function kc(t){return"storage/"+t}function uP(){const t="An unknown error occurred, please check the error payload for server response.";return new hn(ln.UNKNOWN,t)}function hP(){return new hn(ln.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function fP(){return new hn(ln.CANCELED,"User canceled the upload/download.")}function dP(t){return new hn(ln.INVALID_URL,"Invalid URL '"+t+"'.")}function pP(t){return new hn(ln.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function tp(t){return new hn(ln.INVALID_ARGUMENT,t)}function K_(){return new hn(ln.APP_DELETED,"The Firebase app was deleted.")}function gP(t){return new hn(ln.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _P(t,e,n){let r=1,s=null,i=null,a=!1,c=0;function l(){return c===2}let h=!1;function f(...O){h||(h=!0,e.apply(null,O))}function p(O){s=setTimeout(()=>{s=null,t(v,l())},O)}function g(){i&&clearTimeout(i)}function v(O,...$){if(h){g();return}if(O){g(),f.call(null,O,...$);return}if(l()||a){g(),f.call(null,O,...$);return}r<64&&(r*=2);let U;c===1?(c=2,U=0):U=(r+Math.random())*1e3,p(U)}let P=!1;function N(O){P||(P=!0,g(),!h&&(s!==null?(O||(c=2),clearTimeout(s),p(0)):O||(c=1)))}return p(0),i=setTimeout(()=>{a=!0,N(!0)},n),N}function yP(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vP(t){return t!==void 0}function np(t,e,n,r){if(r<e)throw tp(`Invalid value for '${t}'. Expected ${e} or greater.`);if(r>n)throw tp(`Invalid value for '${t}'. Expected ${n} or less.`)}function EP(t){const e=encodeURIComponent;let n="?";for(const r in t)if(t.hasOwnProperty(r)){const s=e(r)+"="+e(t[r]);n=n+s+"&"}return n=n.slice(0,-1),n}var ra;(function(t){t[t.NO_ERROR=0]="NO_ERROR",t[t.NETWORK_ERROR=1]="NETWORK_ERROR",t[t.ABORT=2]="ABORT"})(ra||(ra={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IP{constructor(e,n,r,s,i,a,c,l,h,f,p,g=!0,v=!1){this.url_=e,this.method_=n,this.headers_=r,this.body_=s,this.successCodes_=i,this.additionalRetryCodes_=a,this.callback_=c,this.errorCallback_=l,this.timeout_=h,this.progressCallback_=f,this.connectionFactory_=p,this.retry=g,this.isUsingEmulator=v,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((P,N)=>{this.resolve_=P,this.reject_=N,this.start_()})}start_(){const e=(r,s)=>{if(s){r(!1,new yo(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const a=c=>{const l=c.loaded,h=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(l,h)};this.progressCallback_!==null&&i.addUploadProgressListener(a),i.send(this.url_,this.method_,this.isUsingEmulator,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(a),this.pendingConnection_=null;const c=i.getErrorCode()===ra.NO_ERROR,l=i.getStatus();if(!c||TP(l,this.additionalRetryCodes_)&&this.retry){const f=i.getErrorCode()===ra.ABORT;r(!1,new yo(!1,null,f));return}const h=this.successCodes_.indexOf(l)!==-1;r(!0,new yo(h,i))})},n=(r,s)=>{const i=this.resolve_,a=this.reject_,c=s.connection;if(s.wasSuccessCode)try{const l=this.callback_(c,c.getResponse());vP(l)?i(l):i()}catch(l){a(l)}else if(c!==null){const l=uP();l.serverResponse=c.getErrorText(),this.errorCallback_?a(this.errorCallback_(c,l)):a(l)}else if(s.canceled){const l=this.appDelete_?K_():fP();a(l)}else{const l=hP();a(l)}};this.canceled_?n(!1,new yo(!1,null,!0)):this.backoffId_=_P(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&yP(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class yo{constructor(e,n,r){this.wasSuccessCode=e,this.connection=n,this.canceled=!!r}}function wP(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function AP(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function RP(t,e){e&&(t["X-Firebase-GMPID"]=e)}function bP(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function SP(t,e,n,r,s,i,a=!0,c=!1){const l=EP(t.urlParams),h=t.url+l,f=Object.assign({},t.headers);return RP(f,e),wP(f,n),AP(f,i),bP(f,r),new IP(h,t.method,f,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,a,c)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function CP(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function PP(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W_="storage";function OP(t=Jl(),e){t=Pn(t);const r=Ia(t,W_).getImmediate({identifier:e}),s=qg("storage");return s&&DP(r,...s),r}function DP(t,e,n,r={}){kP(t,e,n,r)}function VP(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new NP(n,r,s,e,Br)}function xP(){xr(new ir(W_,VP,"PUBLIC").setMultipleInstances(!0)),nn(sp,ip,""),nn(sp,ip,"esm2020")}xP();const LP={apiKey:"YOUR_API_KEY",authDomain:"YOUR_AUTH_DOMAIN",projectId:"YOUR_PROJECT_ID",storageBucket:"YOUR_STORAGE_BUCKET",messagingSenderId:"YOUR_MESSAGING_SENDER_ID",appId:"YOUR_APP_ID"},Pu=Yg(LP),g0=$b(Pu),m0=iP(Pu);OP(Pu);const Nc=!1,Oc={uid:"admin123",email:"admin@camperrental.com",displayName:"Administrador",photoURL:null,isAdmin:!0},MP=eT("auth",{state:()=>({user:null,loading:!1,error:null}),getters:{isAuthenticated:t=>!!t.user,currentUser:t=>t.user},actions:{init(){console.log("Usando datos de ejemplo para autenticación")},async register(t,e,n){this.loading=!0,this.error=null;try{Nc||(this.user={uid:`user_${Date.now()}`,email:t,displayName:n,photoURL:null,isAdmin:!1},console.log("Usuario registrado (simulado):",this.user))}catch(r){throw this.error=r.message||"Error al registrar usuario",console.error("Error de registro:",r),r}finally{this.loading=!1}},async login(t,e){this.loading=!0,this.error=null;try{if(!Nc){if(await new Promise(n=>setTimeout(n,1e3)),t!==Oc.email)throw{code:"auth/not-admin"};if(!e||e.length<6)throw{code:"auth/wrong-password"};return this.user=Oc,Oc}}catch(n){throw this.error=this.handleAuthError(n.code),n}finally{this.loading=!1}},async logout(){try{Nc||await new Promise(t=>setTimeout(t,500)),this.user=null}catch(t){throw this.error=this.handleAuthError(t.code),t}},handleAuthError(t){switch(t){case"auth/email-already-in-use":return"Este correo electrónico ya está en uso";case"auth/invalid-email":return"Correo electrónico inválido";case"auth/user-disabled":return"Usuario deshabilitado";case"auth/user-not-found":return"Usuario no encontrado";case"auth/wrong-password":return"Contraseña incorrecta";case"auth/weak-password":return"La contraseña debe tener al menos 6 caracteres";case"auth/not-admin":return"Solo el administrador puede iniciar sesión";default:return"Error de autenticación"}}}}),FP={class:"navbar"},UP={class:"navbar-container"},BP={class:"navbar-logo"},jP={class:"navbar-start"},$P={class:"navbar-end"},HP={key:0,class:"navbar-item has-dropdown"},qP={class:"navbar-link"},zP={class:"navbar-dropdown"},KP=Oi({__name:"AppNavbar",setup(t){const e=aI(),n=MP(),{isAuthenticated:r,currentUser:s}=tT(n),i=ki(!1),a=()=>{i.value=!i.value},c=()=>{i.value=!1},l=async()=>{try{await n.logout(),e.push("/"),c()}catch(f){console.error("Error al cerrar sesión:",f)}},h=wt(()=>s.value?.displayName||"Usuario");return(f,p)=>{const g=Fl("router-link");return kr(),Uo("nav",FP,[me("div",UP,[me("div",BP,[Ne(g,{to:"/",onClick:c},{default:St(()=>p[0]||(p[0]=[me("span",{class:"logo-text"},"🚐",-1)])),_:1,__:[0]})]),me("div",{class:"navbar-toggle",onClick:a},p[1]||(p[1]=[me("span",null,null,-1),me("span",null,null,-1),me("span",null,null,-1)])),me("div",{class:ua(["navbar-menu",{"is-active":i.value}])},[me("div",jP,[p[4]||(p[4]=me("span",{class:"navbar-item brand-text"},[Ut("TuCamper"),me("span",{class:"brand-highlight"},".com")],-1)),Ne(g,{to:"/",class:"navbar-item navbar-item-bold",onClick:c},{default:St(()=>p[2]||(p[2]=[Ut("Inicio",-1)])),_:1,__:[2]}),Ne(g,{to:"/reservations",class:"navbar-item navbar-item-bold",onClick:c},{default:St(()=>p[3]||(p[3]=[Ut("Mis Reservas",-1)])),_:1,__:[3]})]),me("div",$P,[Cr(r)?(kr(),Uo("div",HP,[me("a",qP,Sl(h.value),1),me("div",zP,[Ne(g,{to:"/admin",class:"navbar-item"},{default:St(()=>p[5]||(p[5]=[Ut("Panel de Control",-1)])),_:1,__:[5]}),me("a",{class:"navbar-item",onClick:l},"Cerrar sesión")])])):(kr(),jl(g,{key:1,to:"/login",class:"navbar-item",onClick:c},{default:St(()=>p[6]||(p[6]=[Ut("Área de Administración",-1)])),_:1,__:[6]}))])],2)])])}}}),G_=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},WP=G_(KP,[["__scopeId","data-v-d1ae6cc7"]]),GP={class:"footer"},QP={class:"footer-container"},YP={class:"footer-section"},JP={class:"footer-section"},XP={class:"footer-bottom"},ZP=Oi({__name:"AppFooter",setup(t){return(e,n)=>{const r=Fl("router-link");return kr(),Uo("footer",GP,[me("div",QP,[n[7]||(n[7]=me("div",{class:"footer-section"},[me("h3",null,"TuCamper.com"),me("p",null,"Tu destino para alquilar campers y autocaravanas de calidad. Explora la libertad de viajar a tu ritmo.")],-1)),me("div",YP,[n[3]||(n[3]=me("h3",null,"Enlaces rápidos",-1)),me("ul",null,[me("li",null,[Ne(r,{to:"/"},{default:St(()=>n[0]||(n[0]=[Ut("Inicio",-1)])),_:1,__:[0]})]),me("li",null,[Ne(r,{to:"/login"},{default:St(()=>n[1]||(n[1]=[Ut("Área de Administración",-1)])),_:1,__:[1]})]),me("li",null,[Ne(r,{to:"/reservations"},{default:St(()=>n[2]||(n[2]=[Ut("Mis Reservas",-1)])),_:1,__:[2]})])])]),me("div",JP,[n[6]||(n[6]=me("h3",null,"Legal",-1)),me("ul",null,[me("li",null,[Ne(r,{to:"/privacy-policy"},{default:St(()=>n[4]||(n[4]=[Ut("Política de Privacidad",-1)])),_:1,__:[4]})]),me("li",null,[Ne(r,{to:"/cookie-policy"},{default:St(()=>n[5]||(n[5]=[Ut("Política de Cookies",-1)])),_:1,__:[5]})])])]),n[8]||(n[8]=rE('<div class="footer-section" data-v-2d9325d5><h3 data-v-2d9325d5>Contacto</h3><ul data-v-2d9325d5><li data-v-2d9325d5>Email: info@tucamper.com</li><li data-v-2d9325d5>Teléfono: +34 123 456 789</li><li data-v-2d9325d5>Dirección: Calle Principal 123, Madrid</li></ul></div><div class="footer-section" data-v-2d9325d5><h3 data-v-2d9325d5>Síguenos</h3><div class="social-links" data-v-2d9325d5><a href="#" aria-label="Facebook" data-v-2d9325d5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-2d9325d5><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" data-v-2d9325d5></path></svg></a><a href="#" aria-label="Twitter" data-v-2d9325d5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-2d9325d5><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" data-v-2d9325d5></path></svg></a><a href="#" aria-label="Instagram" data-v-2d9325d5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-2d9325d5><rect x="2" y="2" width="20" height="20" rx="5" ry="5" data-v-2d9325d5></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" data-v-2d9325d5></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" data-v-2d9325d5></line></svg></a></div></div>',2))]),me("div",XP,[me("p",null,"© "+Sl(new Date().getFullYear())+" TuCamper.com. Todos los derechos reservados.",1)])])}}}),e0=G_(ZP,[["__scopeId","data-v-2d9325d5"]]),t0={class:"app"},n0={class:"main-content"},r0=Oi({__name:"App",setup(t){return(e,n)=>{const r=Fl("router-view");return kr(),Uo("div",t0,[Ne(WP),me("main",n0,[Ne(r,null,{default:St(({Component:s})=>[Ne(EE,{name:"fade",mode:"out-in"},{default:St(()=>[(kr(),jl(Av(s)))]),_:2},1024)]),_:1})]),Ne(e0)])}}}),ku=zE(r0);ku.use(GE());ku.use(Ug);ku.mount("#app");export{g0 as A,d0 as B,h0 as C,p0 as D,Jt as F,G_ as _,me as a,rE as b,Uo as c,Oi as d,Ne as e,Ut as f,i0 as g,kr as h,o0 as i,MP as j,ki as k,l0 as l,wt as m,aI as n,Gp as o,c0 as p,s0 as q,Fl as r,tT as s,Sl as t,Cr as u,a0 as v,St as w,ua as x,eT as y,f0 as z};
